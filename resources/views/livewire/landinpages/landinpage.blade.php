                ...
                <div class="mt-6 flow-root">
                    <div class="-my-6 divide-y divide-gray-500/10">
                        <div class="space-y-2 py-6">
                            ...
                            <a href="#" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">Serviços</a>
                            <a href="#" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">Orçamento</a>
                        </div>
{{--                        <div class="py-6">--}}
...
{{--        Sobre nós--}}
        ...
        <div class="relative -z-10 mt-32 px-6 lg:px-8" id="orcamento">
            ...
            <div class="mx-auto max-w-2xl text-center">
                ...
                <p class="mx-auto mt-6 max-w-xl text-lg leading-8 text-gray-600">Preencha o formulário abaixo con seus dados para solicitar o seu orçamento</p>
            </div>
